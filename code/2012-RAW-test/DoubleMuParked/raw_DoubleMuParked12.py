...
# with command line options: reco -s RAW2DIGI,L1Reco,RECO,USER:EventFilter/HcalRawToDigi/hcallaserhbhehffilter2012_cff.hcallLaser2012Filter --data --conditions FT53_V21A_AN6::All --eventcontent AOD --no_exec --python raw_DoubleMuParked.py
...
process.AODoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('reco_DoubleMuParked12_AOD.root'),
