...
process.source = cms.Source("PoolSource",
    ...
    fileNames = cms.untracked.vstring('root://eospublic.cern.ch//eos/opendata/cms/Run2011A/SingleElectron/RAW/v1/000/161/233/46F82D54-3055-E011-99A9-001D09F24259.root')
)
...
process.AODoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('reco_SingleElectron11_AOD.root'),
