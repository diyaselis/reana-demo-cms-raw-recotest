...
process.source = cms.Source("PoolSource",
    ...
    fileNames = cms.untracked.vstring('root://eospublic.cern.ch//eos/opendata/cms/Run2011A/DoubleMu/RAW/v1/000/163/371/2A795FF1-BF6E-E011-9D0B-00304879FBB2.root')
)
...
process.AODoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('reco_DoubleMu_AOD.root'),
