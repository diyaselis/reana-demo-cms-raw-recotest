...
process.source = cms.Source("PoolSource",
    ...
    fileNames = cms.untracked.vstring('root://eospublic.cern.ch//eos/opendata/cms/Run2011A/SingleMu/RAW/v1/000/163/289/0CDA725E-E06C-E011-BC0C-003048F024FE.root')
)
...
process.AODoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('reco_SingleMu11_AOD.root'),
